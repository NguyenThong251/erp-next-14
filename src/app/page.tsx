"use client";
import Comments from "@/components/cms/tasks/tabs/Comments";
import Files from "@/components/cms/tasks/tabs/Files";
import Progress from "@/components/cms/tasks/tabs/Progress";
import { App, Badge, Button, Space, Tabs, TabsProps } from "antd";
...
export default function Home() {
  ...
  const showTaskDetail = () => {
    modalRef.current = modal.info({
      content: <RenderDetailTask onClose={() => modalRef.current?.destroy()} />,
      width: 678,
  ...
  return (
    <>
      <Space wrap>
        <Button type="primary" onClick={showTaskDetail}>
          Open modal
        </Button>
      </Space>
    </>
...
export const RenderDetailTask = ({ onClose }: { onClose: () => void }) => {
